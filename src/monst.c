...
#ifndef SPLITMON_2
NEARDATA struct permonst playermon =
/*
 * special case used by weapons bonus code
 */
    MON("player", S_HUMAN,
	LVL(1, 10, 10, 0, 0), (G_GENO|G_NOGEN),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, PL_NSIZ, MS_HUMANOID, MZ_HUMAN), 0, 0,
	M1_NEEDPICK|M1_HUMANOID|M1_OMNIVORE,
	M2_HUMAN|M2_STRONG|M2_COLLECT, 0, HI_DOMESTIC);

NEARDATA struct permonst *uasmon = &playermon;
 ...
 */
	...
	M1_ANIMAL|M1_NOHANDS|M1_OVIPAROUS, M2_HOSTILE, 0, CLR_YELLOW),
/*
 * dogs & other canines
 */
    MON("jackal", S_DOG,
	...
	M2_STRONG|M2_DOMESTIC, 0, HI_DOMESTIC),
    MON("wolf", S_DOG,
	...
	M1_ANIMAL|M1_NOHANDS|M1_CARNIVORE,
	M2_NOPOLY|M2_HOSTILE|M2_STRONG|M2_PNAME|M2_MALE, 0, CLR_RED),
#endif
/*
 * eyes
 */
	...
	M2_NOPOLY|M2_HOSTILE|M2_NEUTER, 0, CLR_BROWN),
#endif
/*
 * felines
 */
	...
	M1_ANIMAL|M1_NOHANDS|M1_CARNIVORE,
	M2_WANDER|M2_DOMESTIC, 0, HI_DOMESTIC),
 ...
 */
	...
	M1_SWIM|M1_HUMANOID|M1_POIS, M2_STALK, 0, CLR_GREEN),
 ...
 */
	...
	M2_HOSTILE|M2_NASTY|M2_GREEDY|M2_JEWELS|M2_COLLECT, 0, CLR_MAGENTA),
/*
 ...
 */
	...
	M1_POIS, M2_HOSTILE|M2_STALK, 0, CLR_RED),
	...
	M2_HOSTILE|M2_WANDER|M2_STALK|M2_NEUTER, 0, CLR_BROWN),
    MON("quasit", S_IMP,
 ...
 */
	...
	M1_HUMANOID|M1_TPORT, M2_HOSTILE|M2_GREEDY, 0, CLR_GREEN),
/*
 * mimics
 */
 ...
 */
	...
	M1_HUMANOID|M1_TPORT, M2_HOSTILE|M2_FEMALE|M2_COLLECT, 0, CLR_GREEN),
	...
	M2_HOSTILE|M2_FEMALE|M2_COLLECT, 0, CLR_BLUE),
    MON("mountain nymph", S_NYMPH,
	LVL(3, 12, 9, 20, 0), (G_GENO|2),
	A(ATTK(AT_CLAW, AD_SITM, 0, 0), ATTK(AT_CLAW, AD_SEDU, 0, 0),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(600, 300, 0, MS_SEDUCE, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_TPORT, M2_HOSTILE|M2_FEMALE|M2_COLLECT, 0, CLR_BROWN),
/*
 * orcs
 */
    MON("goblin", S_ORC,
 ...
 */
	...
	M1_ANIMAL|M1_NOHANDS|M1_POIS|M1_CARNIVORE, M2_HOSTILE, 0, CLR_BROWN),
	...
	M2_HOSTILE|M2_GREEDY|M2_JEWELS|M2_COLLECT, 0, CLR_GRAY),
/*
 * spiders & scorpions
 */
 ...
 */
	...
	M1_NOHANDS|M1_HERBIVORE, M2_WANDER|M2_STRONG|M2_JEWELS, 0, CLR_WHITE),
    MON("gray unicorn", S_UNICORN,
	LVL(4, 24, 2, 70, 0), (G_GENO|1),
	A(ATTK(AT_BUTT, AD_PHYS, 1,12), ATTK(AT_KICK, AD_PHYS, 1, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(1300, 300, 0, MS_NEIGH, MZ_LARGE), MR_POISON, MR_POISON,
	M1_NOHANDS|M1_HERBIVORE, M2_WANDER|M2_STRONG|M2_JEWELS, 0, CLR_GRAY),
    MON("black unicorn", S_UNICORN,
	LVL(4, 24, 2, 70, -7), (G_GENO|1),
	A(ATTK(AT_BUTT, AD_PHYS, 1,12), ATTK(AT_KICK, AD_PHYS, 1, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(1300, 300, 0, MS_NEIGH, MZ_LARGE), MR_POISON, MR_POISON,
	M1_NOHANDS|M1_HERBIVORE, M2_WANDER|M2_STRONG|M2_JEWELS, 0, CLR_BLACK),
/*
 * vortices
 */
 ...
 */
	...
	M1_ANIMAL|M1_SLITHY|M1_NOLIMBS|M1_CARNIVORE, M2_HOSTILE, 0, CLR_BROWN),
    MON("baby purple worm", S_WORM,
	LVL(8, 3, 5, 0, 0), G_GENO,
	A(ATTK(AT_BITE, AD_PHYS, 1, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(600, 250, 0, MS_SILENT, MZ_LARGE), 0, 0,
	M1_ANIMAL|M1_SLITHY|M1_NOLIMBS|M1_CARNIVORE, M2_HOSTILE, 0, CLR_MAGENTA),
 ...
 */
	...
	MR_FIRE|MR_COLD|MR_ELEC|MR_DISINT|MR_SLEEP|MR_POISON|MR_ACID|
	  MR_STONE, 0,
	M1_FLY|M1_BREATHLESS|M1_AMORPHOUS|M1_NOEYES|M1_NOLIMBS|M1_NOHEAD|
	  M1_MINDLESS|M1_UNSOLID|M1_SEE_INVIS,
 ...
 */
	...
	MR_COLD|MR_ELEC|MR_SLEEP|MR_POISON, 0,
	M1_HUMANOID|M1_SEE_INVIS,
	M2_NOPOLY|M2_MINION|M2_STALK|M2_STRONG|M2_NASTY|M2_COLLECT, 0, CLR_WHITE),
    MON("ki-rin", S_ANGEL,
	LVL(16, 18, -5, 90, 15), (G_NOHELL|G_NOCORPSE|1),
	A(ATTK(AT_KICK, AD_PHYS, 2, 4), ATTK(AT_KICK, AD_BLND, 2, 4),
	  ATTK(AT_BUTT, AD_PHYS, 3, 6), NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_NEIGH, MZ_LARGE), 0, 0,
	M1_FLY|M1_SEE_INVIS,
	M2_NOPOLY|M2_MINION|M2_STALK|M2_STRONG|M2_NASTY|M2_LORD, 0, HI_GOLD),
    MON("Archon", S_ANGEL,
 ...
 */
	...
	M1_FLY|M1_ANIMAL|M1_NOHANDS|M1_CARNIVORE, M2_WANDER, 0, CLR_BROWN),
    MON("giant bat", S_BAT,
 ...
 */
	...
	M1_FLY|M1_THICK_HIDE|M1_NOHANDS|M1_CARNIVORE,
	M2_HOSTILE|M2_STRONG|M2_GREEDY|M2_JEWELS, 0, CLR_RED),
	...
	M1_FLY|M1_THICK_HIDE|M1_NOHANDS|M1_SEE_INVIS|M1_OVIPAROUS|
	  M1_CARNIVORE,
	M2_HOSTILE|M2_STRONG|M2_NASTY|M2_GREEDY|M2_JEWELS|M2_MAGIC, 0, CLR_RED),
 ...
 */
	...
	M1_NOEYES|M1_NOLIMBS|M1_NOHEAD|M1_MINDLESS|M1_UNSOLID|M1_FLY,
	M2_STRONG|M2_NEUTER, 0, CLR_YELLOW),
 ...
 */
	...
	M1_ANIMAL|M1_HUMANOID|M1_CARNIVORE,
	M2_HOSTILE|M2_STRONG|M2_NASTY|M2_COLLECT, 0, CLR_BROWN),
    MON("titan", S_GIANT,
	LVL(16, 18, -3, 70, 9), (1),
 ...
 */
	...
	M2_HOSTILE|M2_STRONG|M2_NASTY|M2_COLLECT, 0, CLR_ORANGE),
#ifdef KOPS
/*
 * Kops
 */
	...
	M2_HUMAN|M2_WANDER|M2_HOSTILE|M2_MALE|M2_COLLECT, 0, CLR_BLUE),
    MON("Kop Sergeant", S_KOP,
	LVL(2, 8, 10, 10, 10), (G_GENO|G_SGROUP|G_NOGEN),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 200, 0, MS_ARREST, MZ_HUMAN), 0, 0, M1_HUMANOID,
	M2_HUMAN|M2_WANDER|M2_HOSTILE|M2_STRONG|M2_MALE|M2_COLLECT, 0, CLR_BLUE),
    MON("Kop Lieutenant", S_KOP,
	LVL(3, 10, 10, 20, 11), (G_GENO|G_NOGEN),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 200, 0, MS_ARREST, MZ_HUMAN), 0, 0, M1_HUMANOID,
	M2_HUMAN|M2_WANDER|M2_HOSTILE|M2_STRONG|M2_MALE|M2_COLLECT, 0, CLR_CYAN),
 ...
 */
	...
	M2_UNDEAD|M2_HOSTILE|M2_MAGIC, 0, CLR_BROWN),
    MON("demilich", S_LICH,
	...
	MR_COLD|MR_SLEEP|MR_POISON, MR_COLD,
	M1_BREATHLESS|M1_HUMANOID|M1_POIS|M1_REGEN,
	M2_UNDEAD|M2_HOSTILE|M2_MAGIC, 0, CLR_RED),
	...
	M1_BREATHLESS|M1_HUMANOID|M1_POIS|M1_REGEN,
	M2_UNDEAD|M2_HOSTILE|M2_MAGIC, M3_WANTSBOOK, HI_LORD),
/*
 * Mummies
 */
	...
	M2_UNDEAD|M2_HOSTILE, 0, CLR_BROWN),
	...
	M1_BREATHLESS|M1_MINDLESS|M1_HUMANOID|M1_POIS,
	M2_UNDEAD|M2_HOSTILE, 0, CLR_RED),
	...
	M1_BREATHLESS|M1_MINDLESS|M1_HUMANOID|M1_POIS,
	M2_UNDEAD|M2_HOSTILE|M2_ORC|M2_GREEDY|M2_JEWELS, 0, CLR_GRAY),
	...
	M1_BREATHLESS|M1_MINDLESS|M1_HUMANOID|M1_POIS,
	M2_UNDEAD|M2_HOSTILE|M2_ELF, 0, CLR_GREEN),
	...
	MR_COLD|MR_SLEEP|MR_POISON, 0,
	M1_BREATHLESS|M1_MINDLESS|M1_HUMANOID|M1_POIS,
	M2_UNDEAD|M2_HOSTILE, 0, CLR_GRAY),
	...
	MR_COLD|MR_SLEEP|MR_POISON, 0,
	M1_BREATHLESS|M1_MINDLESS|M1_HUMANOID|M1_POIS,
	M2_UNDEAD|M2_HOSTILE|M2_STRONG, 0, CLR_BLUE),
	...
	MR_COLD|MR_SLEEP|MR_POISON, 0,
	M1_BREATHLESS|M1_MINDLESS|M1_HUMANOID|M1_POIS,
	M2_UNDEAD|M2_HOSTILE|M2_GIANT|M2_STRONG|M2_JEWELS, 0, CLR_CYAN),
/*
 * Nagas
 */
	...
	MR_FIRE|MR_POISON, MR_FIRE|MR_POISON,
	M1_NOLIMBS|M1_SLITHY|M1_THICK_HIDE, M2_STRONG, 0, CLR_RED),
	...
	M1_NOLIMBS|M1_SLITHY|M1_THICK_HIDE|M1_ACID, M2_STRONG, 0, CLR_BLACK),
    MON("golden naga hatchling", S_NAGA,
	LVL(3, 10, 6, 0, 0), G_GENO,
	A(ATTK(AT_BITE, AD_PHYS, 1, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(500, 100, 0, MS_MUMBLE, MZ_LARGE), MR_POISON, MR_POISON,
	M1_NOLIMBS|M1_SLITHY|M1_THICK_HIDE, M2_STRONG, 0, HI_GOLD),
    MON("guardian naga hatchling", S_NAGA,
	LVL(3, 10, 6, 0, 0), G_GENO,
	A(ATTK(AT_BITE, AD_PHYS, 1, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(500, 100, 0, MS_MUMBLE, MZ_LARGE), MR_POISON, MR_POISON,
	M1_NOLIMBS|M1_SLITHY|M1_THICK_HIDE, M2_STRONG, 0, CLR_GREEN),
    MON("red naga", S_NAGA,
	...
	MR_FIRE|MR_POISON, MR_FIRE|MR_POISON,
	M1_NOLIMBS|M1_SLITHY|M1_THICK_HIDE|M1_OVIPAROUS, M2_STRONG, 0, CLR_RED),
 ...
 */
	...
	A(ATTK(AT_BITE, AD_RUST, 3, 8), ATTK(AT_NONE, AD_RUST, 0, 0),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
 ...
 */
	...
	M1_SWIM|M1_ANIMAL|M1_NOHANDS|M1_METALLIVORE, M2_HOSTILE, 0, CLR_BROWN),
/*
 * Snakes
 */
	...
	M1_SWIM|M1_NOLIMBS|M1_ANIMAL|M1_SLITHY|M1_CARNIVORE|M1_OVIPAROUS,
	M2_HOSTILE|M2_STRONG, 0, CLR_MAGENTA),
    MON("cobra", S_SNAKE,
 ...
 */
	...
	M1_HUMANOID|M1_REGEN|M1_CARNIVORE,
	M2_STRONG|M2_STALK|M2_HOSTILE|M2_COLLECT, 0, CLR_CYAN),
	...
	M2_STRONG|M2_STALK|M2_HOSTILE, 0, CLR_BLUE),
	...
	M1_HUMANOID|M1_REGEN|M1_CARNIVORE,
	M2_STRONG|M2_STALK|M2_HOSTILE|M2_COLLECT, 0, HI_LORD),
/*
 * Umber hulk
 */
	...
	M1_TUNNEL|M1_CARNIVORE, M2_STRONG, 0, CLR_BROWN),
/*
 * Vampires
 */
	...
	M2_UNDEAD|M2_STALK|M2_HOSTILE|M2_STRONG|M2_NASTY, 0, CLR_RED),
	...
	M3_WAITFORU|M3_WANTSBOOK, HI_LORD),
/*
 * Wraiths
 */
 ...
 */
	...
	M1_ANIMAL|M1_HUMANOID|M1_CARNIVORE, M2_STRONG, 0, CLR_BROWN),
    MON("owlbear", S_YETI,
	...
	M1_ANIMAL|M1_HUMANOID|M1_CARNIVORE, M2_HOSTILE|M2_STRONG, 0, CLR_WHITE),
	...
	M1_ANIMAL|M1_HUMANOID|M1_CARNIVORE, M2_HOSTILE|M2_STRONG, 0, CLR_BLACK),
	...
	M1_ANIMAL|M1_HUMANOID|M1_SEE_INVIS|M1_OMNIVORE, M2_STRONG, 0, CLR_GRAY),
/*
 * Zombies
 */
	...
	SIZ(850, 75, 0, MS_SILENT, MZ_HUMAN), MR_COLD|MR_SLEEP|MR_POISON, 0,
	M1_BREATHLESS|M1_MINDLESS|M1_HUMANOID|M1_POIS,
	M2_UNDEAD|M2_STALK|M2_HOSTILE|M2_ORC, 0, CLR_GRAY),
	...
	M2_UNDEAD|M2_STALK|M2_HOSTILE|M2_ELF, 0, CLR_GREEN),
	...
	MR_COLD|MR_SLEEP|MR_POISON, 0,
	M1_BREATHLESS|M1_MINDLESS|M1_HUMANOID,
	M2_UNDEAD|M2_STALK|M2_HOSTILE, 0, HI_DOMESTIC),
	...
	MR_COLD|MR_SLEEP|MR_POISON, 0,
	M1_BREATHLESS|M1_MINDLESS|M1_HUMANOID,
	M2_UNDEAD|M2_STALK|M2_HOSTILE|M2_STRONG, 0, CLR_BLUE),
	...
	MR_COLD|MR_SLEEP|MR_POISON, 0,
	M1_BREATHLESS|M1_MINDLESS|M1_HUMANOID,
	M2_UNDEAD|M2_STALK|M2_HOSTILE|M2_GIANT|M2_STRONG, 0, CLR_CYAN),
 ...
 */
	...
	LVL(3, 12, 10, 0, 0), (G_GENO|G_NOCORPSE|1),
	A(ATTK(AT_CLAW, AD_PHYS, 1, 2), ATTK(AT_CLAW, AD_PHYS, 1, 2),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	LVL(4, 9, 8, 0, 0), (G_GENO|G_NOCORPSE|1),
	A(ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
	...
	LVL(6, 6, 6, 0, 0), (G_GENO|G_NOCORPSE|1),
	A(ATTK(AT_CLAW, AD_PHYS, 1, 6), ATTK(AT_CLAW, AD_PHYS, 1, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	LVL(7, 3, 4, 0, 0), (G_GENO|G_NOCORPSE|1),
	A(ATTK(AT_CLAW, AD_PHYS, 3, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	LVL(11, 7, 7, 40, 0), (G_GENO|G_NOCORPSE|1),
	...
	LVL(14, 6, 5, 50, 0), (G_GENO|G_NOCORPSE|1),
	...
	LVL(18, 6, 3, 60, 0), (G_GENO|G_NOCORPSE|1),
 ...
 */
	...
	SIZ(WT_ELF, 350, 0, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
	M1_HUMANOID|M1_OMNIVORE|M1_SEE_INVIS,
	M2_ELF|M2_COLLECT, 0, CLR_BRIGHT_GREEN),
	...
	SIZ(WT_ELF, 350, 0, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
	M1_HUMANOID|M1_OMNIVORE|M1_SEE_INVIS,
	M2_ELF|M2_STRONG|M2_LORD|M2_MALE|M2_COLLECT, 0, CLR_BRIGHT_BLUE),
	...
	SIZ(WT_ELF, 350, 0, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
	M1_HUMANOID|M1_OMNIVORE|M1_SEE_INVIS,
	M2_ELF|M2_STRONG|M2_PRINCE|M2_MALE|M2_COLLECT, 0, HI_LORD),
    MON("nurse", S_HUMAN,
	...
	M1_HUMANOID|M1_OMNIVORE,
	M2_NOPOLY|M2_HUMAN|M2_PEACEFUL|M2_FEMALE, 0, HI_ZAP),
	...
	M2_NOPOLY|M2_HUMAN|M2_LORD|M2_PEACEFUL|M2_COLLECT, 0, CLR_WHITE),
	...
	0, CLR_WHITE),
    MON("soldier", S_HUMAN,
	LVL(6, 4, 10, 0, -2), (G_SGROUP|G_GENO|1),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	LVL(8, 4, 10, 5, -3), (G_SGROUP|G_GENO|1),
	A(ATTK(AT_WEAP, AD_PHYS, 2, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_SOLDIER, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
	...
	LVL(6, 4, 10, 0, -2), (G_SGROUP|G_NOGEN|G_GENO|1),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_SOLDIER, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
	...
	LVL(10, 4, 10, 15, -4), (G_NOGEN|G_GENO|1),
	A(ATTK(AT_WEAP, AD_PHYS, 3, 4), ATTK(AT_WEAP, AD_PHYS, 3, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_SOLDIER, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
	...
	M3_COVETOUS|M3_WAITFORU, HI_LORD),
    MON("Croesus", S_HUMAN,
 ...
 */
	...
	M2_DEMON|M2_STALK|M2_HOSTILE|M2_NASTY, 0, CLR_BROWN),
#ifdef SEDUCE
...
# define SEDUCTION_ATTACKS \
	...
	M2_DEMON|M2_STALK|M2_HOSTILE|M2_NASTY|M2_FEMALE, 0, CLR_GRAY),
    MON("incubus", S_DEMON,
	LVL(6, 12, 0, 70, -9), (G_NOCORPSE|1),
	SEDUCTION_ATTACKS,
	SIZ(WT_HUMAN, 400, 0, MS_SEDUCE, MZ_HUMAN), MR_FIRE|MR_POISON, 0,
	M1_HUMANOID|M1_FLY|M1_POIS,
	M2_DEMON|M2_STALK|M2_HOSTILE|M2_NASTY|M2_MALE, 0, CLR_GRAY),
#undef SEDUCTION_ATTACKS
	...
	SIZ(WT_HUMAN, 400, 0, MS_SILENT, MZ_HUMAN), MR_FIRE|MR_POISON, 0,
	M1_POIS|M1_THICK_HIDE, M2_DEMON|M2_STALK|M2_HOSTILE|M2_NASTY, 0, CLR_RED),
	...
	M2_DEMON|M2_STALK|M2_HOSTILE|M2_NASTY|M2_FEMALE|M2_COLLECT, 0, CLR_RED),
    MON("vrock", S_DEMON,
	...
	M1_POIS, M2_DEMON|M2_STALK|M2_HOSTILE|M2_NASTY, 0, CLR_RED),
    MON("hezrou", S_DEMON,
	...
	A(ATTK(AT_WEAP, AD_PHYS, 3, 4), ATTK(AT_STNG, AD_DRST, 2, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_SILENT, MZ_LARGE), MR_FIRE|MR_POISON, 0,
	M1_POIS, M2_DEMON|M2_STALK|M2_HOSTILE|M2_NASTY|M2_COLLECT, 0, CLR_GRAY),
	...
	M2_DEMON|M2_STALK|M2_HOSTILE|M2_NASTY, 0, CLR_WHITE),
	...
	M2_DEMON|M2_STALK|M2_HOSTILE|M2_NASTY|M2_COLLECT, 0, CLR_RED),
    MON("balrog", S_DEMON,
	...
	M2_DEMON|M2_STALK|M2_HOSTILE|M2_STRONG|M2_NASTY|M2_COLLECT, 0, CLR_RED),
	...
	M2_NOPOLY|M2_DEMON|M2_STALK|M2_HOSTILE|M2_PNAME|M2_NASTY|M2_LORD|
	  M2_MALE,
	M3_WAITFORU|M3_WANTSAMUL, CLR_BRIGHT_GREEN),
	...
	M2_NOPOLY|M2_DEMON|M2_STALK|M2_HOSTILE|M2_PNAME|M2_NASTY|M2_PRINCE|
	  M2_MALE|M2_COLLECT,
	M3_WAITFORU|M3_WANTSBOOK|M3_WANTSAMUL, HI_LORD),
    MON("Geryon", S_DEMON,
	...
	M2_NOPOLY|M2_DEMON|M2_STALK|M2_HOSTILE|M2_PNAME|M2_NASTY|
	  M2_PRINCE|M2_MALE,
	M3_WANTSAMUL|M3_WAITFORU, HI_LORD),
	...
	M2_NOPOLY|M2_STALK|M2_PEACEFUL, 0, CLR_BRIGHT_BLUE),
#endif
    MON("djinni", S_DEMON,
	...
	M1_HUMANOID|M1_FLY|M1_POIS,
	M2_NOPOLY|M2_STALK|M2_COLLECT, 0, CLR_YELLOW),
/*
 * sea monsters
 */
    MON("giant eel", S_EEL,
	...
	M2_NOPOLY|M2_HOSTILE|M2_STRONG, 0, CLR_RED),
/*
 * lizards, &c
 */
    MON("newt", S_LIZARD,
	...
	M2_STALK|M2_HOSTILE|M2_COLLECT|M2_MAGIC, 0, CLR_ORANGE),
 ...
 */
	...
	M2_NOPOLY|M2_HUMAN|M2_STRONG|M2_COLLECT, 0, HI_DOMESTIC),
    MON("caveman", S_HUMAN,
	LVL(10, 10, 10, 0, 1), G_NOGEN,
	A(ATTK(AT_WEAP, AD_PHYS, 2, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_HUMANOID, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
	M2_NOPOLY|M2_HUMAN|M2_STRONG|M2_MALE|M2_COLLECT, 0, HI_DOMESTIC),
	...
	SIZ(WT_HUMAN, 400, 0, MS_HUMANOID, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
	M2_NOPOLY|M2_HUMAN|M2_STRONG|M2_FEMALE|M2_COLLECT, 0, HI_DOMESTIC),
	...
	SIZ(WT_ELF, 350, 0, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
	M1_HUMANOID|M1_OMNIVORE|M1_SEE_INVIS,
	M2_NOPOLY|M2_ELF|M2_STRONG|M2_COLLECT, 0, HI_DOMESTIC),
#ifdef FIGHTER
    MON("fighter", S_HUMAN,
	LVL(10, 12, 10, 2, 3), G_NOGEN,
	A(ATTK(AT_WEAP, AD_PHYS, 1, 8),
	...
	SIZ(WT_HUMAN, 400, 0, MS_HUMANOID, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
	M2_NOPOLY|M2_HUMAN|M2_STRONG|M2_COLLECT|M2_MAGIC, 0, HI_DOMESTIC),
/*
 * quest leaders
 */
	...
	LVL(20, 15, 0, 30, -20), (G_NOGEN|G_UNIQ),
	A(ATTK(AT_WEAP, AD_PHYS, 2, 6), ATTK(AT_WEAP, AD_PHYS, 2, 6),
	...
	LVL(20, 10, 10, 20, 0), (G_NOGEN|G_UNIQ),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_LEADER, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
	M2_NOPOLY|M2_HUMAN|M2_PNAME|M2_PEACEFUL|M2_STRONG|M2_MALE|
	  M2_COLLECT|M2_MAGIC,
	M3_CLOSE, HI_DOMESTIC),
#endif
    MON("Norn", S_HUMAN,
	LVL(20, 15, 0, 80, 0), (G_NOGEN|G_UNIQ),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_LEADER, MZ_HUMAN), MR_COLD, 0,
	M1_HUMANOID|M1_OMNIVORE,
 ...
 */
	...
	LVL(16, 10, -2, 75, -14), (G_NOCORPSE|G_NOGEN|G_UNIQ),
	A(ATTK(AT_WEAP, AD_PHYS, 8, 4), ATTK(AT_WEAP, AD_PHYS, 4, 6),
	...
	LVL(16, 10, 0, 10, -14), (G_NOGEN|G_UNIQ),
...
#endif
    MON("Cyclops", S_GIANT,
	LVL(18, 10, 0, 0, -15), (G_NOGEN|G_UNIQ),
	...
	M3_WANTSARTI|M3_WAITFORU, CLR_GRAY),
    MON("Ixoth", S_DRAGON,
	LVL(15, 9, -1, 20, -14), (G_NOGEN|G_UNIQ),
	...
	M3_WANTSARTI|M3_WAITFORU, CLR_RED),
    MON("Nalzok", S_DEMON,
	LVL(16, 10, -2, 85, -127), (G_NOGEN|G_UNIQ|G_NOCORPSE),
	A(ATTK(AT_WEAP, AD_PHYS, 8, 4), ATTK(AT_WEAP, AD_PHYS, 4, 6),
	  ATTK(AT_MAGC, AD_SPEL, 0, 0), ATTK(AT_CLAW, AD_SAMU, 2, 6),
	  NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_NEMESIS, MZ_LARGE), MR_FIRE|MR_POISON, 0,
	...
	LVL(15, 15, 0, 30, 18), (G_NOGEN|G_UNIQ),
	...
	LVL(15, 15, 0, 40, -13), (G_NOGEN|G_UNIQ),
	A(ATTK(AT_WEAP, AD_PHYS, 2, 6), ATTK(AT_WEAP, AD_PHYS, 2, 6),
	  ATTK(AT_CLAW, AD_SAMU, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_NEMESIS, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
	...
	LVL(15, 10, 0, 80, -10), (G_NOGEN|G_UNIQ),
 ...
 */
	...
	M1_TUNNEL|M1_NEEDPICK|M1_HUMANOID|M1_OMNIVORE,
	M2_NOPOLY|M2_HUMAN|M2_PEACEFUL|M2_STRONG|M2_COLLECT, 0, HI_DOMESTIC),
    MON("chieftain", S_HUMAN,
	LVL(5, 10, 10, 10, 0), G_NOGEN,
	A(ATTK(AT_WEAP, AD_PHYS, 1, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	M1_HUMANOID|M1_SEE_INVIS|M1_OMNIVORE,
	M2_NOPOLY|M2_ELF|M2_PEACEFUL|M2_COLLECT, 0, HI_DOMESTIC),
#ifdef FIGHTER
	...
	SIZ(WT_HUMAN, 400, 0, MS_HUMANOID, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
	M2_NOPOLY|M2_HUMAN|M2_HOSTILE|M2_STRONG|M2_COLLECT, 0, HI_DOMESTIC),
    MON("roshi", S_HUMAN,
	LVL(5, 10, 10, 10, 3), G_NOGEN,
	A(ATTK(AT_WEAP, AD_PHYS, 1, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
