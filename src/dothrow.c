...
/*JP			You("have no ammunition readied!");*/
			You("発射準備が整っていない！");
			return(dothrow());
		}
		autoquiver();
		if (!uquiver) {
/*JP			You("have nothing appropriate for your quiver!");*/
			You("発射するものがない！");
			return(dothrow());
		} else {
/*JP			You("fill your quiver:");*/
			You("装填した:");
...
/*JP		pline("%s misfires!", The(xname(obj)));*/
...
/*JP		    pline("%s %s %s back to you.", Monnam(mon),
