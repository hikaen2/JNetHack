...
/*JP		    You("feel an unexpected draft.");*/
		    You("思いもよらず，すきま風を感じた．");
...
/*JP			       You("hear a door unlock and open.");*/
			       You("扉の鍵がはずれ，開く音を聞いた．");
		        }
