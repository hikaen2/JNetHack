...
/*JP    end_menu(win, to_advance ?	"Pick a skill to advance:" :
				"Current skills:");*/
    end_menu(win, to_advance ?	"技量を高める武器を選択してください：" :
				"現在の技量：");
