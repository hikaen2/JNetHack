...
#endif
    { "¶¯¤µ",	SV_VALUE, (Widget) 0, -1, 0, FALSE, FALSE },	/* 0*/
    { "ÁÇÁá¤µ",	SV_VALUE, (Widget) 0, -1, 0, FALSE, FALSE },
    { "ÂÑµ×ÎÏ",	SV_VALUE, (Widget) 0, -1, 0, FALSE, FALSE },
    { "ÃÎÎÏ",	SV_VALUE, (Widget) 0, -1, 0, FALSE, FALSE },
    { "¸­¤µ",	SV_VALUE, (Widget) 0, -1, 0, FALSE, FALSE },
    { "Ì¥ÎÏ",	SV_VALUE, (Widget) 0, -1, 0, FALSE, FALSE },	/* 5*/

    { "",		SV_LABEL, (Widget) 0, -1, 0, FALSE, FALSE }, /* name */
    { "",		SV_LABEL, (Widget) 0, -1, 0, FALSE, FALSE }, /* dlvl */
    { "¶â",		SV_VALUE, (Widget) 0, -1, 0, FALSE, FALSE },
    { "ÂÎÎÏ",		SV_VALUE, (Widget) 0, -1, 0, FALSE, FALSE },
    { "ºÇÂçÂÎÎÏ",	SV_VALUE, (Widget) 0, -1, 0, FALSE, FALSE },	/*10*/
    { "ËâÎÏ",		SV_VALUE, (Widget) 0, -1, 0, FALSE, FALSE },
    { "ºÇÂçËâÎÏ",	SV_VALUE, (Widget) 0, -1, 0, FALSE, FALSE },
    { "³»",		SV_VALUE, (Widget) 0,256, 0, FALSE, FALSE },
    { "¥ì¥Ù¥ë",		SV_VALUE, (Widget) 0, -1, 0, FALSE, FALSE },
    { "·Ð¸³",		SV_VALUE, (Widget) 0, -1, 0, FALSE, FALSE },	/*15*/
    { "Â°À­",		SV_VALUE, (Widget) 0, -2, 0, FALSE, FALSE },
    { "»þ´Ö",		SV_VALUE, (Widget) 0, -1, 0, FALSE, FALSE },
    { "¥¹¥³¥¢",		SV_VALUE, (Widget) 0, -1, 0, FALSE, FALSE },

    { "",		SV_NAME,  (Widget) 0, -1, 0, FALSE, TRUE }, /* hunger*/
    { "¡¡º®Íð¡¡",	SV_NAME,  (Widget) 0,  0, 0, FALSE, TRUE },	/*20*/
    { "¡¡ÉÂµ¤¡¡",	SV_NAME,  (Widget) 0,  0, 0, FALSE, TRUE },
    { "¡¡ÌÕÌÜ¡¡",	SV_NAME,  (Widget) 0,  0, 0, FALSE, TRUE },
    { "  âÁÚô  ",	SV_NAME,  (Widget) 0,  0, 0, FALSE, TRUE },
    { "¡¡¸¸³Ð¡¡",	SV_NAME,  (Widget) 0,  0, 0, FALSE, TRUE },
    { "",		SV_NAME,  (Widget) 0,  0, 0, FALSE, TRUE }, /*encumbr*/
};
...
/*JP	    Strcpy(buf, (new_value == A_CHAOTIC) ? "Chaotic" :
			(new_value == A_NEUTRAL) ? "Neutral" :
						   "Lawful"  );*/
	    Strcpy(buf, (new_value == A_CHAOTIC) ? "º®ÆÙ" :
			(new_value == A_NEUTRAL) ? "ÃæÎ©" :
						   "Ãá½ø"  );
	} else {
	    Sprintf(buf, "%ld", new_value);
	}
